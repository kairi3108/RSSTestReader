...
+ (NSDictionary *)dictionaryForXMLParser:(NSXMLParser *)parser error:(NSError **)error {
    ...
    NSDictionary *rootDictionary = [reader objectWithParser:parser options:0];
...
+ (NSDictionary *)dictionaryForXMLParser:(NSXMLParser *)parser options:(XMLReaderOptions)options error:(NSError **)errorPointer {
    XMLReader *reader = [[XMLReader alloc] initWithError:errorPointer];
    NSDictionary *rootDictionary = [reader objectWithParser:parser options:options];
    return rootDictionary;
}
